...
export declare class MockedSubscriptionProvider extends React.Component<
  any,
  any
> {
  private client;
...
export declare function mockNetworkInterface(
  ...mockedResponses: MockedResponse[]
): NetworkInterface;
export declare function mockSubscriptionNetworkInterface(
...
export declare class MockSubscriptionNetworkInterface extends MockNetworkInterface
